  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day: cn(buttonVariants({ variant: "calender" }), "h-9 w-9 text-center items-center justify-center p-0 font-normal aria-selected:opacity-100"),
        day_range_end: "day-range-end",
        day_selected: "bg-pink-brand text-white   text-center flex items-center justify-center hover:bg-pink-brand",
        day_today: " bg-pink-secondary text-black ",
